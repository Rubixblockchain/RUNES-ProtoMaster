...
from test_framework.test_framework import RÜNESTestFramework, SkipTest
...
class ZMQTest (RÜNESTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that RÜNES has been built with ZMQ enabled
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("RÜNESd has not been built with zmq enabled.")
