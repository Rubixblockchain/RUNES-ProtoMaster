...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the RÜNESTestFramework
    pass

class ExampleTest(RÜNESTestFramework):
    # Each functional test is a subclass of the RÜNESTestFramework class.
    ...
    def custom_method(self):
        ...
        RÜNESTestFramework class so other tests can use it."""
