Contributing to RÜNES
============================

The RÜNES project operates an open contributor model where anyone is
...
The following applies to code changes to the RÜNES project, and is not to be
confused with overall RÜNES Network Protocol consensus changes.

Whether a pull request is merged into RÜNES rests with the project merge
...
Patches that change RÜNES consensus rules are considerably more involved than
...
Where a patch set proposes to change the RÜNES consensus, it must have been
...
The project leader is the release manager for each RÜNES release.
