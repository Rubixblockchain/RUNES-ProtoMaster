...
In order to support loading of multiple wallets in RÜNES-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is RÜNES.cpp.
...
Changes to RÜNES.cpp
----------------------
RÜNES.cpp is the entry point into RÜNES-qt, and as such, will require some minor modifications to provide hooks for
