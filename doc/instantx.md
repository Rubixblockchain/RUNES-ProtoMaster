...
This mechanism has been integrated into Bitcore-Node-RÜNES which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/RÜNES-Project/insight-api-RÜNES#web-socket-api](https://github.com/RÜNES-Project/insight-api-RÜNES#web-socket-api) 
* API: [https://github.com/RÜNES-Project/insight-api-RÜNES#instantx-transactions](https://github.com/RÜNES-Project/insight-api-RÜNES#instantx-transactions)
...
By default, the RÜNES daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the RÜNES daemon:
