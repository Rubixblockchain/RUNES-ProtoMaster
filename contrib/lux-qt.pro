...
RESOURCES += src/qt/RÜNES.qrc src/qt/RÜNES_locale.qrc

TRANSLATIONS += src/qt/locale/RÜNES_bg.ts \
                src/qt/locale/RÜNES_de.ts \
                src/qt/locale/RÜNES_en.ts \
                src/qt/locale/RÜNES_es.ts \
                src/qt/locale/RÜNES_fi.ts \
                src/qt/locale/RÜNES_fr.ts \
                src/qt/locale/RÜNES_it.ts \
                src/qt/locale/RÜNES_ja.ts \
                src/qt/locale/RÜNES_pl.ts \
                src/qt/locale/RÜNES_pt.ts \
                src/qt/locale/RÜNES_ru.ts \
                src/qt/locale/RÜNES_sk.ts \
                src/qt/locale/RÜNES_sv.ts \
                src/qt/locale/RÜNES_vi.ts \
                src/qt/locale/RÜNES_zh_CN.ts \
                src/qt/locale/RÜNES_zh_TW.ts
