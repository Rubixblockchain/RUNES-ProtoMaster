...
#include "genesis/RÜNESMainNetwork.cpp"
#include "genesis/RÜNESTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
	...
	case Network::RÜNESMainNetwork: return c_genesisInfoRÜNESMainNetwork;
	case Network::RÜNESTestNetwork: return c_genesisInfoRÜNESTestNetwork;
	default:
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
	...
	case Network::RÜNESMainNetwork: return c_genesisStateRootRÜNESMainNetwork;
	case Network::RÜNESTestNetwork: return c_genesisStateRootRÜNESTestNetwork;
	default:
		throw std::invalid_argument("Invalid network value");
	}
}
