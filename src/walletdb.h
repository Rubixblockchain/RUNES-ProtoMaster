...
public:
    ...
    bool WriteRÜNESNodeConfig(std::string sAlias, const CRÜNESNodeConfig& nodeConfig);
    bool ReadRÜNESNodeConfig(std::string sAlias, CRÜNESNodeConfig& nodeConfig);
    bool EraseRÜNESNodeConfig(std::string sAlias);
