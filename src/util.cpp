...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "Runes.conf"));
                    ...
                    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good())
    {
        boost::filesystem::path ConfPath;
               ConfPath = GetDataDir() / "Runes.conf";
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "Runesd.pid"));
