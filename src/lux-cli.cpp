...
static bool AppInitRPC(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help") || mapArgs.count("-version")) {
        std::string strUsage = _("RÜNES RPC client version") + " " + FormatFullVersion() + "\n";
        if (!mapArgs.count("-version")) {
            strUsage += "\n" + _("Usage:") + "\n" +
                        "  RÜNES-cli [options] <command> [params]  " + _("Send command to RÜNES") + "\n" +
                        "  RÜNES-cli [options] help                " + _("List commands") + "\n" +
                        "  RÜNES-cli [options] help <command>      " + _("Get help for a command") + "\n";
