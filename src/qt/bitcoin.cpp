...
#if defined(RUNES_NEED_QT_PLUGINS) && !defined(_RUNES_QT_PLUGINS_INCLUDED)
#define _RUNES_QT_PLUGINS_INCLUDED
#define __INSURE__
#include <QtPlugin>
...
static void handleRunawayException(std::exception *e)
{
    ...
    QMessageBox::critical(0, "Runaway exception", BitcoinGUI::tr("A fatal error occurred. Runes can no longer continue safely and will quit.") + QString("\n\n") + QString::fromStdString(strMiscWarning));
    exit(1);
}
...
int main(int argc, char *argv[])
{
    ...
    if(GetBoolArg("-testnet", false)) // Separate UI settings for testnet
        app.setApplicationName("Runes-Qt-testnet");
    else
        app.setApplicationName("Runes-Qt");
