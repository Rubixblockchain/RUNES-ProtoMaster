...
void BlockBrowser::updateExplorer(bool block)
{
    ...
    if(block == false) {
        ...
        ui->valueBox->setText(QValue + " RÜNES");
        ui->txID->setText(QID);
        ui->outputBox->setText(QOutputs);
        ui->inputBox->setText(QInputs);
        ui->feesBox->setText(QFees + " RÜNES");
    }
}
...
void BlockBrowser::updateStatistics()
{
    ...
    {
        ui->volumeBox_2->setText("<b><font color=\"green\">" + qVolume + " RÜNES" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox_2->setText("<b><font color=\"red\">" + qVolume + " RÜNES" + "</font></b>");
    } else {
        ui->volumeBox_2->setText(qVolume + " RÜNES");
    }
