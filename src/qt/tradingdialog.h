...
#ifndef RÜNES_TRADINGDIALOG_H
#define RÜNES_TRADINGDIALOG_H
...
private slots:
    ...
    void showBalanceOfRÜNESOnTradingTab();
    ...
    void showBalanceOfRÜNESOnSendTab();
    void showBalanceOfRÜNESOnBalanceTab();
    ...
    QString BuyRÜNES(QString OrderType, double Quantity, double Rate);
    QString SellRÜNES(QString OrderType, double Quantity, double Rate);
    ...
    QString sendRequest(QString url, QString method = "GET", QString body = QString("{\"market\":\"RÜNES/BTC\"}"));// "{\"gender\":\"male\"}");
    void sendRequest1(QString url, std::function<void (void)> funcForCallAfterReceiveResponse, QString method = "GET", QString body = QString("{\"market\":\"RÜNES/BTC\"}"));// "{\"gender\":\"male\"}");
